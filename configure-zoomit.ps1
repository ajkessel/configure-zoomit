...
param(
    [string]$Webcam,   # "on" or "off"
    [string]$Audio,    # "on" or "off"
    [switch]$Help
)
...
# update if your ZoomIt is installed in a different location
...
# --- Headless mode: at least one param was supplied ---
if ($Webcam -or $Audio) {
...
$btn.Text = "Apply && Restart"
$btn.Location = New-Object System.Drawing.Point(40, 65)
